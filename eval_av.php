                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form method="post" action="Controlleurs/add_eav.php">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                if ($i < 9) {
                                                                    ...
                                                                    $val = "Respects de exigences";
                                                                } else if ($i >= 15 && $i < 16) {
                                                                    $val = "Respect des délais/quantités";
                                                                } else if ($i >= 16 && $i < 17) {
                                                                    $val = "Réactivité";
                                                                } else if ($i >= 17 && $i < 19) {
                                                                    $val = "Production";
                                            ...
                                            <div class="form-horizontal form-label-left" id="resultat">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input class="form-control col-md-7 col-xs-12"
                                                               name="classe" id="classe" readonly="" type="text" required="">
                                                    </div>
                                                </div>
