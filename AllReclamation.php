                                                ...
                                                foreach ($rec as $value) {
                                                    if ($value->idFrn == $_SESSION['idlogin']) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value->ncmdRec; ?></td>
                                                            <td><?php echo $value->dateRec; ?></td>
                                                            <td><?php echo $value->dateRepRec; ?></td>
                                                            <td><?php echo $value->etatRec; ?></td>
                                                            <td style="width: 20%">
                                                                <a class="btn btn-link" href="getReclamation.php?idRec=<?php echo $value->idRec; ?>" target="_blank"><i class="fa fa-eye"></i> Voir</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
