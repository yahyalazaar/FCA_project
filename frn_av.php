                                    ...
                                    <div class="x_content">
                                        <table id="datatable-buttons"
                                            ...
                                            <tbody>
                                                ...
                                                $am = new EvalamontMySqlDAO();
                                                $am = $am->queryAll();
                                                foreach ($am as $val) {
                                                    $value = $frn->load($val->idFrn);
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%">
                                                            <a class="btn btn-link" href="eval_av.php?frn=<?php echo$value->idFrn; ?>"><i class="fa fa-edit"></i> Créer évaluation</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
